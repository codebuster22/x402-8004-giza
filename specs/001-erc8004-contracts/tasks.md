...
- [x] T099 [P] Extract StrategyRegistry ABI from out/StrategyRegistry.sol/StrategyRegistry.json to contracts/abi/StrategyRegistry.json
- [x] T100 [P] Extract StrategyReputation ABI from out/StrategyReputation.sol/StrategyReputation.json to contracts/abi/StrategyReputation.json
